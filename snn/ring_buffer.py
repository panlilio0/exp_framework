...
Authors: Atharv Tekurkar, Jonathan Fischman, Abhay Kashyap
"""
...
class RingBuffer:
    ...
    def __init__(self, buffsize: int):
        ...
        Parameters:
            buffsize (int): How big the RingBuffer should be.
        """
    ...
    def get(self, n: int = None) -> list:
        ...
        Parameters:
            n (int): Optionally, teturns the most recent `n` elements (latest to oldest).
    ...
    def length(self) -> int:
        ...
        Returns:
            int: Current number of elements in the buffer.
        """
