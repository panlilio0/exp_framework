...
class Actuator:
    ...
    ----------
    voxelindexJ : int:
        index of the voxel in the json grid.
    ...
    def __init__(self, voxel_index_j, voxel_index_a, voxeltype, pmis):
        self.voxel_index_j = voxel_index_j # location of voxel in json grid (int)
